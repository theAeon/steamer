...
task generate_dataset {
    ...
    GCS_OAUTH_TOKEN=$(gcloud auth application-default print-access-token --lifetime=43200  --impersonate-service-account=$(curl -s "http://metadata.google.internal/computeMetadata/v1/project/numeric-project-id" -H "Metadata-Flavor: Google")-compute@developer.gserviceaccount.com) \
